...
|__   __|                                / __ \  / ____|
   ...
   | |    / _ \| '_ \ / __| / _ \ | '__|| |  | | \___ \
   | |   |  __/| | | |\__ \| (_) || |   | |__| | ____) |
   |_|    \___||_| |_||___/ \___/ |_|    \____/ |_____/



          --- Made by TensorOS with YOU ---
EOF
...
readonly CASA_UNINSTALL_URL="https://raw.githubusercontent.com/johnqing-424/tensoros-ui/main/tensoros-uninstall"
...
"https://raw.githubusercontent.com/johnqing-424/tensoros-ui/main/linux-all-tensoros-v0.4.20.tar.gz"
...
Welcome_Banner() {
    ...
    echo -e "   TensorOS ${CASA_TAG}${COLOUR_RESET} is running at${COLOUR_RESET}${GREEN_SEPARATOR}"
    echo -e "${GREEN_LINE}"
    Get_IPs
